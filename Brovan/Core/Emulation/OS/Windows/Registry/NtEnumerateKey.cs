        ...
        {
            {
                ...
                uint Index = (uint)Instance.WinHelper.GetArg(1);
                KEY_INFORMATION_CLASS KeyInformationClass = (KEY_INFORMATION_CLASS)(uint)Instance.WinHelper.GetArg(2);
                ulong KeyInformationPtr = Instance.WinHelper.GetArg(3);
