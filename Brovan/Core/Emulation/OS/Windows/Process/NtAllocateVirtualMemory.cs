...
namespace Brovan.Core.Emulation.OS.Windows
{
    internal class NtAllocateVirtualMemory : IWinSyscall
    {
        ...
        public NTSTATUS Handle(BinaryEmulator Instance)
        {
            ...
            NTSTATUS Status = Allocate(Instance, ref BaseAddress, ref RegionSize, (uint)AllocationTypeValue, (uint)ProtectValue);
        ...
        internal static NTSTATUS Allocate(BinaryEmulator Instance, ref ulong BaseAddress, ref ulong RegionSize, uint AllocationType, uint Protect)
        {
            bool Reserve = (AllocationType & 0x2000) != 0; // MEM_RESERVE
            bool Commit = (AllocationType & 0x1000) != 0;  // MEM_COMMIT
