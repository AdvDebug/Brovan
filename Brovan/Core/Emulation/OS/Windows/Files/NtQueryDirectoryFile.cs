...
namespace Brovan.Core.Emulation.OS.Windows
{
    internal class NtQueryDirectoryFile : IWinSyscall
    {
        ...
        public NTSTATUS Handle(BinaryEmulator Instance)
        {
            ...
            NTSTATUS Status = NtQueryDirectoryFileCommon.Handle(Instance, FileHandle, EventHandle, IoStatusBlock, FileInformation, Length, FileInformationClass, QueryFlags, FileName);
